...
const FACING_N = new Set([
  ...
  CELL.ROOF_N, CELL.ROOF_NE, CELL.ROOF_NW,
...
const FACING_S = new Set([
  ...
  CELL.ROOF_S, CELL.ROOF_SE, CELL.ROOF_SW,
  CELL.IROOF_S, CELL.IROOF_SE, CELL.IROOF_SW,
  CELL.IROOF_END_N, CELL.IROOF_END_E, CELL.IROOF_END_W, CELL.IROOF_ISLAND,
]);
...
const FACING_E = new Set([
  ...
  CELL.ROOF_E, CELL.ROOF_NE, CELL.ROOF_SE,
  CELL.IROOF_E, CELL.IROOF_NE, CELL.IROOF_SE,
  CELL.IROOF_END_N, CELL.IROOF_END_S, CELL.IROOF_END_W, CELL.IROOF_ISLAND,
]);
...
const FACING_W = new Set([
  ...
  CELL.ROOF_W, CELL.ROOF_NW, CELL.ROOF_SW,
  CELL.IROOF_W, CELL.IROOF_NW, CELL.IROOF_SW,
  CELL.IROOF_END_N, CELL.IROOF_END_S, CELL.IROOF_END_E, CELL.IROOF_ISLAND,
]);
